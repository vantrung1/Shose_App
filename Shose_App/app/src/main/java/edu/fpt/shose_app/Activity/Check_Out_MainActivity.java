...
import edu.fpt.shose_app.zalo.Helper.Api.CreateOrder;
        ...
        btn_payment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(PaymentAmount.equalsIgnoreCase("Zalo Pay")){
                    ...
                    CreateOder(1, 1,02304302403, data_price,"note",PaymentAmount,"1",jsonprocuts,3);
                }
       ...
       // address_checkout.setText(Utils.Users_Utils.getEmail());
        ...
        for(Cart product : Utils.cartLists){
            if(product.isIscheck() == true){
                ...
                edu.fpt.shose_app.Model.products products1 =new products(product.getIdProduct(),product.getCartName(),product.getImage(),product.getQuantity(),product.getPrice(),product.getSize(),1,attributes);
